                        ...
                        <ul class="navbar-nav w-100">
                            <li class="nav-item w-100">
                                <select name="type" style="color:white" class="form-control" id="exampleInputUsername1">
                                    ...
                                    <option value="Theory" {{(Request::get('type') == 'Theory') ? 'selected':''}} class="form-control">Theory</option>
                                    <option value="Practical" {{(Request::get('type') == 'Practical') ? 'selected':''}} class="form-control">Practical</option>
                                </select>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="navbar-nav w-100">
                            <li class="nav-item w-100">
                                <div class="nav-link mt-2 mt-md-0 d-none d-lg-flex search">
                                    ...
                                    <a href="{{url('admin/subject/list')}}" class="btn btn-info mx-3 btn-md">Clear</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-2">
                            <a class="nav-link btn btn-success create-new-button text-black"
                                href="{{ url('admin/subject/add') }}">+ Add new Subject</a>
                        </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color:white;"> {{ $value->type }} </td>
                                        @if($value->status == 1)
